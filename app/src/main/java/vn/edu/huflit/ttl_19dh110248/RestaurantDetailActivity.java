...
import vn.edu.huflit.ttl_19dh110248.adapter.FoodAdapter;
import vn.edu.huflit.ttl_19dh110248.fragment.AddToBasketDialogFragment;
import vn.edu.huflit.ttl_19dh110248.fragment.BasketDialogFragment;
        ...
        if(food != null){
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    StorageReference profileRef = fStorage.getReference().child("covers/"+ restaurant.getCover());
